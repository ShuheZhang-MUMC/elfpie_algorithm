...
### Optimizer: 
The optimizer used in ELFPIE is a combination of AdaBelif and AdaDelta. The learning-rate $\boldsymbol{\delta}$ is adaptively adjusted according to historical gradient. <br>
We choose $r_1 = 0.9$, $r_2 = 0.999$, and $\boldsymbol{\delta}^0 = 100$ for learning the parameters. <br>
