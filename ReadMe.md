...
```math
\left \| \bigtriangledown\bigtriangledown \mathbf{X} \right\|_{1} = \left \| \left(\bigtriangledown_{xx} \mathbf{X}\right)^{2} + \bigtriangledown_{yy} \mathbf{X} \bigtriangledown_{xy} \mathbf{X} \right\|_{2}
```
